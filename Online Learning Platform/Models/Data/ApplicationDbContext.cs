    ...
    public class ApplicationDbContext : IdentityDbContext<UserBase, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Instructor>().HasData(
                new Instructor { Id = 1, FirstName = "Heba", LastName = "Mohammed", Email = "Heba@gmail.com", ImageUrl = "/images/teacher_1.jpg", RoleName = "Instructor" },
                new Instructor { Id = 2, FirstName = "Shahd", LastName = "Sofy", Email = "Shahd@gmail.com", ImageUrl = "/images/teacher_4.jpg" , RoleName = "Instructor" }
            );
